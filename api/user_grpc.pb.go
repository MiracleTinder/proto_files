...
const (
	...
	UserService_GetUserByLogin_FullMethodName = "/api.UserService/GetUserByLogin"
	UserService_SavePhoto_FullMethodName      = "/api.UserService/SavePhoto"
...
func (c *userServiceClient) SavePhoto(ctx context.Context, in *SavePhotoRequest, opts ...grpc.CallOption) (*SavePhotoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SavePhotoResponse)
	err := c.cc.Invoke(ctx, UserService_SavePhoto_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) SavePhoto(context.Context, *SavePhotoRequest) (*SavePhotoResponse, error) {
...
func _UserService_SavePhoto_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SavePhotoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SavePhoto(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SavePhoto_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SavePhoto(ctx, req.(*SavePhotoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_SavePhoto_Handler,
		},
		{
